...
const tasks: Task[] = [
  {
    ...
    description: "Выпустите временный JWT (на 1 час) для быстрых тестов или создайте постоянный ключ для интеграции в ваш бэкенд.",
  ...
  },
  {
    key: "hasViewedModels",
    guide: "models",
    title: "Выберите LLM-модель",
    description: "Изучите лимиты и выберите «мозг» для агента. Скопируйте системный ID модели (например, gpt-4o) для передачи в API.",
  ...
  },
  {
    key: "hasViewedMCP",
    guide: "mcp",
    title: "Подключите MCP-инструменты",
    description: "Дайте агенту доступ к данным. Выберите коннектор (Jira, Google Workspace и др.) и скопируйте готовую npx-команду для запуска.",
